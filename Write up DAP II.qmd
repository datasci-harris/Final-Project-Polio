...
Image(filename=r"C:\Users\arifm\OneDrive\Documents\GitHub\Final-Project-Polio\heatmap.png")
```
...
```{python}
from IPython.display import Image
Image(filename=r"C:\Users\arifm\OneDrive\Documents\GitHub\Final-Project-Polio\bubble_map.png")
```
